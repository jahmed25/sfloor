            ...
            <div id="navbar-inner" class="navbar-inner navbar-inactive">
               ...
               <ul id="mobilemenu" class="mobilemenu nav-collapse collapse">
                  <li class="level0 nav-1 level-top first parent">
                     ...
                     <ul style="display: none;" class="level0">
                        ...
                        <li class="level1 nav-1-2 parent">
                           <a href="/women/dresses#"><span>Dresses</span> </a>
                           <ul style="display: none;" class="level1">
                        ...
                        <li class="level1 nav-1-4 last parent">
                           ...
                           <ul style="display: none;" class="level1">
                              ...
                              <li class="level2 nav-1-4-19"><a href=""><span>Shoulders</span> </a></li>
                              <li class="level2 nav-1-4-20 last"><a href=""><span>Satchels</span> </a></li>
                           </ul>
                           <span class="head"><a href=""></a></span>
                        </li>
                     </ul>
                  ...
                  <li class="level0 nav-2 level-top parent">
                     <a href="" class="level-top"><span>Men</span>
                     </a>
                     <ul style="display: none;" class="level0">
                  ...
                  <li class="level0 nav-3 level-top parent">
                     <a href="/kids#" class="level-top"><span>Home
                     & Decor</span> </a>
                     <ul style="display: none;" class="level0">
                        <li class="level1 nav-3-1 first parent">
                           <a href="#"><span>Boys</span> </a>
                           <ul style="display: none;" class="level1">
                        ...
                        <li class="level1 nav-3-2 parent">
                           <a href="/kids/girls#"><span>Girls</span> </a>
                           <ul style="display: none;" class="level1">
                        ...
                        <li class="level1 nav-3-3 last parent">
                           <a href="/kids/accessories#"><span>Accessories</span>
                           </a>
                           <ul style="display: none;" class="level1">
                  ...
                  <li class="level0 nav-4 level-top parent">
                     <a href="/accessories#" class="level-top">
                     <span>Brands</span> </a>
                     <ul style="display: none;" class="level0">
                  ...
                  <li class="level0 nav-5 level-top"><a href="" class="level-top"><span>Offer</span> </a>
                  </li>
               </ul>
            </div>
         </div>
