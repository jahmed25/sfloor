...
<table border="0">
<tr><td>Email Id :</td>
    <td><%=shippingDT.Rows[0]["EMAIL"]%></td></tr>
<tr><td>Name :</td><td><%=shippingDT.Rows[0]["NAME"]%></td></tr>
<tr><td>Phone :</td><td><%=shippingDT.Rows[0]["MOBILE"]%></td></tr>
<tr><td>Address :</td><td><%=shippingDT.Rows[0]["ADDRESS"]%></td></tr>
<tr><td>City :</td><td><%=shippingDT.Rows[0]["CITY"]%></td></tr>
<tr><td>State :</td><td><%=shippingDT.Rows[0]["STATE"]%></td></tr>
<tr><td>Pin:</td><td><%=shippingDT.Rows[0]["PIN"]%></td></tr>
</table>
</div>
...
<div class="orderdetails">	
    <table border="1" bordercolor="#ABABAB"><thead class="header">
            <tr>
                <th>Product</th>
             	<th>Brand</th>
