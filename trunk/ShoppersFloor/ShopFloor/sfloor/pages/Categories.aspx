                  ...
                  <div class="filters-wrapper">
                     ...
                     <div id='cssmenu'>
                        <ul>
                           <li></li>
                           <li class='has-sub'>
                              <a href='#' id="MainCatHeader" style="border: 1px solid #E4E4E4;
                                 background-color: rgb(246, 246, 246)" runat="server">Accessories<em></em></a><a style="width: 25px;
                                 z-index: 1; text-align: right; background: transparant; float: right; padding: 0px 10px 10px 185px;
                                 top: 5px; cursor: pointer; position: absolute"><em></em></a>
                              <ul style="height: auto" class="scrollbar">
                                 <asp:DataList ID="datalist_categoryname" Visible="true" runat="server" RepeatDirection="Vertical"
                                    RepeatColumns="1">
                                    <ItemTemplate>
                                       <li><a class="lnkbtn_category" href='<%# Eval("url") %>' data="<%# Eval("SKUProductType") %>">
                                          <%# Eval("SKUProductType") %></a> 
                                       </li>
                                    </ItemTemplate>
                                 </asp:DataList>
                     ...
                     <div id='cssmenu'>
                        <ul>
                           <li class='has-sub'>
                              <a href='#' style="border: 1px solid #E4E4E4; background-color: rgb(246, 246, 246)">
                              Brand <em></em></a>
                              <ul>
                                 <asp:DataList ID="datalist_brandname" runat="server" RepeatDirection="Vertical" RepeatColumns="1">
                                    <ItemTemplate>
                                       <li><a class="lnkbtn_category" href="#">
                                          <%# Eval("SKUBrand") %></a>
                                       </li>
                                    </ItemTemplate>
                                 </asp:DataList>
                     ...
                     <div id="cssmenu">
                        <ul class="color1">
                           <li class='has-sub'>
                              ...
                              <ul class="scrollbar">
                                 <li>
                                    <input type="checkbox" id="black" /><a href="#" title="black" style="background-color: Black"></a><label
                                       for="black">Black</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="brown" /><a href="#" title="brown" style="background-color: #7e4f2f"></a><label
                                       for="brown">Brown</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="cream" /><a href="#" title="cream" style="background-color: #f4eedb"></a><label
                                       for="cream">Cream</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="white" /><a href="#" title="white" style="background-color: White"></a><label
                                       for="white">White</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="grey" /><a href="#" title="grey" style="background-color: #b3b3b3"></a><label
                                       for="grey">Grey</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="red" /><a href="#" title="red" style="background-color: #d20000"></a><label
                                       for="red">Red</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="orange" /><a href="#" title="orange" style="background-color: #ff8726"></a><label
                                       for="orange">Orange</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="yellow" /><a href="#" title="yellow" style="background-color: #fbe14e">
                                    </a>
                                    <label for="yellow">
                                    Yellow</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="blue" /><a href="#" title="blue" style="background-color: #00539f"></a><label
                                       for="blue">Blue</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="purple" /><a href="#" title="purple" style="background-color: #472f92"></a><label
                                       for="purple">Purple</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="pink" /><a href="#" title="pink" style="background-color: #f06eaa"></a><label
                                       for="pink">Pink</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="green" /><a href="#" title="green" style="background-color: green"></a><label
                                       for="green">Green</label>
                                 </li>
                                 <li>
                                    <input type="checkbox" id="gold" /><a href="#" title="gold" style="background-color: Gold"></a><label
                                       for="gold">Gold</label>
                                 </li>
                              </ul>
                           </li>
